    ...
    if(isset($_POST['checkBoxArray']))
       {
        ...
        foreach($_POST['checkBoxArray'] as $commentValueId ) {
            ...
            $bulk_options = $POST['bulk_options'];
            ...
            switch($bulk_options) {
                ...
                $update_to_approved_status = mysqli_query($conection,$query);
                ...
                $query = "UPDATE comments SET comment_status = '{bulk_otions}' WHERE comment_id = {$commentValueId} ";
       ...
       <form action="" method="post">
          ...
          <table class="table table-bordered table-hover">
              ...
              <div id="bulkOptionContainer" class="col-xs-4">
                  ...
                  <options value="">Select Options</options>
                  <options value="approved">Approve</options>
                  <options value="unapproved">Unapprove</options>
                  <options value="delete">Delete</options>
                  </select>
