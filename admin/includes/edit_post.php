...
if(isset($_POST['update_post'])) {
    ...
    echo "<p class='bg-success'>Post Updated. <a href='../post.php?p_id={$the_post_id}'>View Post</a> or <a href=''>Edit More Posts</a></p>";
...
-->
    ...
    <select name="post_status" id="">
        ...
        if($post_status == 'published' ) {
            ...
            echo "<option value='publised'>Publish</option>";
